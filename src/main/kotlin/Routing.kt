...
fun Application.configureRouting() {
    ...
    val fruitService: FruitService by inject()
    ...
    routing {
        ...
        get("/") {
            call.respondText("API Fruit telah berjalan 🚀")
        }
        ...
        route("/fruits") {
            ...
            get {
                fruitService.getAllFruits(call)
            }

            post {
                fruitService.createFruit(call)
            }

            get("/{id}") {
                fruitService.getFruitById(call)
            }

            put("/{id}") {
                fruitService.updateFruit(call)
            }

            delete("/{id}") {
                fruitService.deleteFruit(call)
            }

            get("/{id}/image") {
                fruitService.getFruitImage(call)
            }
        }
